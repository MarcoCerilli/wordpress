...
<header class="bg-dark py-5">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            <h1 class="display-4 fw-bolder">Recensioni 1 Stella</h1>
            <p class="lead fw-normal text-white-50 mb-0">Scopri gli eventi con una recensione di 1 stella.</p>
        </div>
    </div>
</header>
    ...
    <div class="container px-4 px-lg-5 mt-5">
        <div class="row gx-4 gx-lg-5 justify-content-center">
            ...
            <?php if (have_posts()) : ?>
                ...
                <?php endwhile; ?>
            <?php else : ?>
                <p class="text-muted">Nessun evento trovato per questa recensione 1 stella.</p>
            <?php endif; ?>
        </div>
    </div>
</section>
